    ...
    public class ApplicantEducationLogic : BaseLogic<ApplicantEducationPoco>
    {
        ...
        protected override void Verify(ApplicantEducationPoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(108, $"Applicant Education Starte Date for {poco.Id} cannot be greater than today"));
                }
                if ((poco.CompletionDate) < (poco.StartDate))
                {
                    exceptions.Add(new ValidationException(109, $"Applicant Education Completion Date for {poco.Id} cannot be earlier than Start Date"));
                }
