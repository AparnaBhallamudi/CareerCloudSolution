...
namespace CareerCloud.WCF
{
    public class Security : ISecurity
    {
        ...
        {
            SecurityLoginLogic logic =
                new SecurityLoginLogic
                (new EFGenericRepository<SecurityLoginPoco>(false));
        ...
        {
            SecurityLoginsLogLogic logic =
                new SecurityLoginsLogLogic
                (new EFGenericRepository<SecurityLoginsLogPoco>(false));
            return logic.Get(Guid.Parse(Id));
        }
        ...
        {
            SecurityLoginsRoleLogic logic =
                new SecurityLoginsRoleLogic
                (new EFGenericRepository<SecurityLoginsRolePoco>(false));
            return logic.Get(Guid.Parse(Id));
        }
